...
enum Action: string
{
    ...
    case DELETE_WAYBILL_TEMPLATE      = 'delete_waybill_tamplate'; // RS API typo — intentional
    ...
    case GET_WAYBILL_TEMPLATE         = 'get_waybill_tamplate';  // RS API typo — intentional
    case GET_WAYBILL_TEMPLATES        = 'get_waybill_tamplates'; // RS API typo — intentional
    ...
    case SAVE_WAYBILL_TEMPLATE        = 'save_waybill_tamplate';    // RS API typo — intentional
    case SAVE_WAYBILL_TRANSPORTER     = 'save_waybill_transporter';
    case SEND_WAYBILL_VD              = 'send_waybil_vd';           // RS API typo — intentional
