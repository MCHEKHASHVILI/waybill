...
class GetWaybillRequest extends BaseRequest implements HasParamsInterface
{
                    ...
                    return array_reduce(
                        ...
                        function ($carry, $product) {
                            $carry[] = new ProductDto(
                                ...
                                unit_name: isset($product["UNIT_TXT"]) ? (string) $product["UNIT_TXT"] : null,
    ...
    {
        $xmlArray = $response->xmlReader()->xpathValue("//WAYBILL")->sole();

        return WaybillDto::fromArray($xmlArray, $this->keyMap);
    }
}
