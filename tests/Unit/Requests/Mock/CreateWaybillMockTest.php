...
XML;
    ...
    test('hasRequestFailed throws WaybillServerException when RS returns an HTML error page', function () {
        // In Saloon v3, hasRequestFailed() is invoked from Response::throw() which only
        // runs for non-2xx. Since RS always returns HTTP 200 even for error pages, we
        // test the guard directly to verify its logic without coupling to Saloon internals.
